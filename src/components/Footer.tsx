        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <a
              ...
              className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-[0_0_15px_rgba(255,255,255,0.5)] hover:shadow-[0_0_25px_rgba(255,255,255,0.7)] transition-shadow"
            >
            ...
            <a
              href="https://tiktok.com/@silviajval"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-[0_0_15px_rgba(255,255,255,0.5)] hover:shadow-[0_0_25px_rgba(255,255,255,0.7)] transition-shadow"
            >
              <Music2 size={26} className="text-[#d199cc]" />
              <span>@silviajval</span>
            </a>
          </div>
          
          <div className="flex items-start gap-3 bg-white rounded-lg p-4 shadow-[0_0_15px_rgba(255,255,255,0.5)] max-w-md mx-auto mb-8">
